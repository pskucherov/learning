var techs = {
        ...
        bemprivCompile: require('./techs/bempriv.js'),
...
module.exports = function(config) {
    ...
    config.nodes('*.bundles/*', function(nodeConfig) {
        nodeConfig.addTechs([
            ...
            //[require('enb-borschik/techs/borschik'), { sourceTarget: '?.priv.js', destTarget: '_?.priv.js', minify: false, freeze: false }],
            //[techs.fileProvider, { target: '?.bemjson.js' }],
            [techs.bemprivCompile, { sourceTarget: '?.bempriv.js', destTarget: '?.bemjson.js' }],
            [enbBemTechs.bemjsonToBemdecl, { sourceTarget: '?.bemjson.js' } ],
            [enbBemTechs.deps],
            [enbBemTechs.files],
            ...
            [techs.htmlFromBemjson, { sourceTarget: '?.bemjson.js' }],
        ...
        nodeConfig.addTargets(['?.bemjson.js', /* '?.bemtree.js', */ '?.html', '_?.css', '_?.js']);
    });
};
